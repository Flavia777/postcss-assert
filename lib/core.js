...
function makeSpritesheetPath(opts, _ref2) {
	...
	return _path2.default.join(opts.spritePath, ['sprite'].concat(_toConsumableArray(groups), [extension]).join('.'));
}
...
function createLogger(enabled) {
	if (enabled) {
		_debug2.default.enable('postcss-assert');
	}

	return (0, _debug2.default)('postcss-assert');
}